...
Load the NOD_1 Visium sample

Quality control and optional spot filtering
...
Selected marker-gene visualization

Biological program scoring

Spatially variable gene analysis

Spatial-gradient modeling using generalized additive models (GAMs)

Native Visium boundary and neighborhood analysis

Graph and clustering-resolution sensitivity analyses

Optional Gene Ontology enrichment

Save the final processed object and output manifest
